...
namespace K22CNTT3_LeTranKhanhDuy_2210900020.Controllers
{
    public class NguoiDungsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "MaNguoiDung,TenDangNhap,Email,MatKhau,VaiTro,NgayTao")] NguoiDung nguoiDung)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "MaNguoiDung,TenDangNhap,Email,MatKhau,VaiTro,NgayTao")] NguoiDung nguoiDung)
        {
            if (ModelState.IsValid)
            {
